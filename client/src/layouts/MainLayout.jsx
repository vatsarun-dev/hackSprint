  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-[var(--background)] text-[var(--foreground)]">
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute left-[12%] top-[-8rem] h-[32rem] w-[32rem] rounded-full bg-[radial-gradient(circle,rgba(103,89,255,0.24),transparent_66%)] blur-3xl" />
        <div className="absolute right-[-6rem] top-[24rem] h-[26rem] w-[26rem] rounded-full bg-[radial-gradient(circle,rgba(74,145,255,0.18),transparent_62%)] blur-3xl" />
